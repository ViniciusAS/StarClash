...
public class WorkAroundStarshipCollision implements StarshipCollision {

    private final StarshipComponents components;
    private final boolean enemy;
    private final StarshipFactory starship;
    
    public WorkAroundStarshipCollision(StarshipFactory starship , StarshipComponents components) {
